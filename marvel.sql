...
-- 3) Oops! Someone at CodeClan spelled Kate's name wrong!
--- Change it to reflect the proper spelling (change 'Kte Preston' to 'Kate Preston').
...
SELECT name
FROM people
WHERE name = 'David Sanchez Rodriguez';
...
-- 8) The cinema has just heard that they will be holding an exclusive midnight showing of 'Guardians of the Galaxy 2'!!
-- Create a new entry in the 'movies' table to reflect this.

INSERT INTO movies (title, year, show_time) VALUES ('Guardians of the Galaxy 2', 2017, '21:15');
SELECT * FROM movies;

-- 9) The cinema would also like to make the Guardian movies a back to back feature.
-- Update the 'Guardians of the Galaxy' show time from 18:55 to 21:30
